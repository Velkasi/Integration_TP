...
##################################Suppression de l'ID###########################
#####Agence 1##########
df_client_agence1 = pd.DataFrame(index=['ID','NomClient','DateInscription','EmailContact','Commentaire'])
df_client_agence1 = df_client_agence1.drop('ID') #Suppression de l'ID car re-création par la BDD
df_client_agence1= df_client_agence1.insert(loc=4, column='Region', value=[]) # Colonne ajoutée : NomClient,DateInscription,EmailContact,"Region",Commentaire

#####Agence 2##########
df_client_agence2 = pd.DataFrame(index=['ClientID','Raison Sociale','email','Inscrit_le','Region']) #Initialisation des données
df_client_agence2 = df_client_agence2.drop('ClientID') #Suppression de l'ID car re-création par la BDD
df_client_agence2 = df_client_agence2.reindex(['ClientID','Raison Sociale','Inscrit_le','email','Region']) # Colonne réorganisé Raison Sociale,"email","Inscrit_le",Region
df_client_agence2 = df_client_agence2.insert(loc=5,value=[], column='Commentaire') # Colonne ajoutée : Raison Sociale,"email","Inscrit_le",Region,"Commentaire"
